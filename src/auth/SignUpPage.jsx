...
const SignUpPage = () => {
  ...
  const handleOAuthSignUp = async (provider) => {
    try {
      ...
      setError(error?.errors?.[0]?.message || `Failed to sign up with ${provider}. Please try again.`);
    }
  };
      ...
      >
        ...
        <div className="text-center mb-6">
          <div className="flex items-center justify-center gap-2 mb-3">
            ...
            <h1 className="text-3xl font-bold text-purple-600">VitaForge</h1>
          </div>
        ...
        {!verifying ? (
          <>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-purple-600 hover:bg-purple-700 text-white font-semibold py-3 rounded-lg transition duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <form onSubmit={handleVerify} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                maxLength={6}
                className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition text-center text-2xl tracking-widest"
              />
            </div>
